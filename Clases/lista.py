    ...
    def barrido_1963(self):
        for value in self.__elements:
            if value.anio_aparicion < 1963:
                print(value.nombre + ",", value.casa)

    def barrido_armadura(self):
        for value in self.__elements:
            if value.biografia.__contains__("armadura") or value.biografia.__contains__("traje"):
                print(value)

    def barrido_letras(self):
        for value in self.__elements:
    ...
    def contar_casa(self):
        ...
        for value in self.__elements:
            ...
            if value.casa == "Marvel":
                con_Marvel = con_Marvel + 1
        print("De DC hay", con_DC, "y de Marvel hay", con_Marvel)